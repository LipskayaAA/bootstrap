...
<div th:fragment="navbar" class="conte">
    <nav class="navbar navbar-dark bg-dark">
        <div>
            <span class="navbar-brand h1 px-md-3" th:text="${user.getEmail()}">Navbar</span>
            <span class="navbar-text">with roles: </span>
            <span class="navbar-text" th:each="role : ${user.getRoles()}" th:text="${role.getName()} + ' '">Navbar</span>
        </div>
        <a class="navbar-text px-md-3" th:href="@{/logout}">Logout</a>
